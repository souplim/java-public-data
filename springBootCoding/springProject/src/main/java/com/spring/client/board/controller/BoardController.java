...
public class BoardController {
	...
	public String boardList(@ModelAttribute BoardVO boardVO, Model model) {
		...
		return "client/board/boardList"; // /WEB-INF/views/board/boardList.jsp // 반환형에는 안 붙음(prefix에 /붙어있음)
	}
	...
	public String writeForm() {
		...
		return "client/board/writeForm"; // /WEB-INF/views/board/writeForm.jsp 
	}
	...
	public String boardDetail(@RequestParam("b_num") int b_num, Model model) throws Exception {
		...
		return "client/board/boardDetail"; // /WEB-INF/views/board/boardDetail.jsp
	}
	...
	public String updateForm(@RequestParam("b_num") int b_num, Model model) {
		...
		BoardVO boardVO = boardService.boardDetail(b_num);
		model.addAttribute("boardVO", boardVO);
		return "client/board/updateForm"; // /WEB-INF/views/board/updateForm.jsp
	}
