...
@Controller
@RequestMapping("/sample/*") // mapping 잡아줄 때 자동으로 추가
@Log4j
public class SampleController {
	
	// http://localhost:8080/sample/start로 요청 (root를 /example -> /로 변경했을 때)
	@RequestMapping(value="/start", method= {RequestMethod.GET, RequestMethod.POST}) // /sample/start라고 할 필요 없음
	public void basicGet() {
		log.info("/sample/start get...................");
		// 반환값 void -> 무조건 /sample/start -> /WEB-INF/views/sample/start.jsp
		// 그러나 헷갈리므로 똑같더라도 주로 String을 반환값으로 해서 메서드 생성함
	}
	
	// 브라우저 요청할 주소 : requestMapping -> http://localhost:8080/sample/basic으로 요청
	@RequestMapping(value="/basic", method= RequestMethod.GET) 
	public String basicGet1() {
		log.info("basic get...................");
		return "basic"; // /WEB-INF/views/basic.jsp (파일은 views 안에 있어야 함)
	}
